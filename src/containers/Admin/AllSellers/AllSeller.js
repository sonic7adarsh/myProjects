...
class AllSellers extends Component{
    ...
    activateHandler = (sellerId) => {
        ...
        axios({
            method: 'Put',
            url: `http://localhost:8080/e-commerce/admin/home/seller-activate/${sellerId}`,
            headers: {
    ...
    deActivateHandler = (sellerId) => {
        ...
        axios({
            method: 'Put',
            url: `http://localhost:8080/e-commerce/admin/home/seller-de-activate/${sellerId}`,
            headers: {
                    'Authorization' : `Bearer ${this.props.token}`
                }
            })
                ...
                <table>
                    ...
                    <tbody>
                         ...
                         <tr key = {seller.id}>
                            ...
                            <td><Button btnType="Success" disable={seller.active} clicked={this.activateHandler.bind(this,seller.id)}>Activate</Button></td>
                            <td><Button btnType="Danger" disable={!seller.active} clicked={this.deActivateHandler.bind(this,seller.id)}>De-Activate</Button></td>
                        </tr>   
                        ))}
                    </tbody>
                </table>
