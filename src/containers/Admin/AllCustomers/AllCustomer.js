                ...
                <table>
                    ...
                    <tbody>
                         ...
                         <tr key = {customer.id}>
                            ...
                            <td><Button btnType="Success" disable={customer.active} clicked={this.activateHandler.bind(this,customer.id)}>Activate</Button></td>
                            <td><Button btnType="Danger" disable={!customer.active} clicked={this.deActivateHandler.bind(this,customer.id)}>De-Activate</Button></td>
                        </tr>   
                        ))}
                    </tbody>
                </table>
